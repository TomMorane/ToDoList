...
const displayFilters = (() => {
  document
    .querySelector('.day')
    .addEventListener('click', () => displayTask('', 'Day'));
  document
    .querySelector('.week')
    .addEventListener('click', () => displayTask('', 'Week'));
  document
    .querySelector('.month')
    .addEventListener('click', () => displayTask('', 'Month'));
})();
...
const sortTask = (() => {
  document
    ...
    .addEventListener('change', () =>
      sortedOptions(document.getElementById('sort').value)
    );
})();
